...
const navItems = [
  ...
  { to: "/mail/voice-commands", icon: Volume2, label: "Voice Console" },
  ...
  { to: "/ani", icon: Sparkles, label: "N0VA ANI" },
  { to: "/ani/memory", icon: BrainCircuit, label: "ANI Memory" },
  { to: "/ani/briefings", icon: ClipboardList, label: "ANI Briefings" },
  { to: "/ani/automations", icon: Workflow, label: "ANI Automations" },
  { to: "/ani/voice", icon: Mic, label: "ANI Voice" },
  ...
  { to: "/n0va1o/overview", icon: LayoutDashboard, label: "N0VA1O Overview" },
  { to: "/n0va1o/catalog", icon: LayoutGrid, label: "Gateway Catalog" },
  { to: "/n0va1o/connections", icon: Plug, label: "Connections" },
  ...
  { to: "/n0va1o/sdk", icon: Code2, label: "SDK" },
  { to: "/n0va1o/deploy", icon: Rocket, label: "Deploy" },
  { to: "/n0va1o/observe", icon: Activity, label: "Observe" },
  { to: "/n0va1o/migration", icon: Database, label: "Migration" },
  { to: "/n0va1o/vfs", icon: HardDrive, label: "VFS Explorer" },
  { to: "/n0va1o/plugins", icon: Puzzle, label: "Plugin Engine" },
  { to: "/n0va1o/audit", icon: ShieldCheck, label: "Audit Center" },
