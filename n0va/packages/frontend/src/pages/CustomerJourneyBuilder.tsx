...
import { GitBranch, Plus, X, Edit3, Trash2, Search, ArrowRight, ArrowDown, ArrowUp, Star, Home, MousePointerClick } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      {loading && (
        <div className="card p-12 flex items-center justify-center text-center">
          ...
          <span className="ml-3 text-gray-400">Loading journeys...</span>
        </div>
      )}
