export class MemoryStore {
  ...
  private seed(): void {
    ...
    const mkDate = (offset: number) => new Date(now + offset * day).toISOString();
    const campaigns = [
      { tenantId: "tenant_001", name: "Q3 Enterprise SaaS Push", type: "performance", status: "active", budget: { daily: 5000, lifetime: 150000, currency: "USD", spent: 45200, remaining: 104800 }, platforms: ["meta", "google", "linkedin"], goal: "Drive Q3 enterprise signups", tags: ["saas", "enterprise", "q3"], startDate: mkDate(-30), endDate: mkDate(60), createdBy: "user_001" },
      { tenantId: "tenant_001", name: "Brand Awareness - Summer Campaign", type: "brand", status: "active", budget: { daily: 3000, lifetime: 90000, currency: "USD", spent: 28100, remaining: 61900 }, platforms: ["meta", "tiktok", "snapchat"], goal: "Increase brand recall by 20%", tags: ["brand", "summer"], startDate: mkDate(-45), endDate: mkDate(30), createdBy: "user_001" },
      { tenantId: "tenant_001", name: "Retargeting - Cart Abandoners", type: "retargeting", status: "active", budget: { daily: 1500, lifetime: 45000, currency: "USD", spent: 12300, remaining: 32700 }, platforms: ["meta", "google"], goal: "Recover abandoned carts", tags: ["retargeting", "ecommerce"], startDate: mkDate(-60), endDate: mkDate(-5), createdBy: "user_001" },
      { tenantId: "tenant_001", name: "Prospecting - New Markets APAC", type: "prospecting", status: "draft", budget: { daily: 2000, lifetime: 60000, currency: "USD", spent: 0, remaining: 60000 }, platforms: ["google", "linkedin"], goal: "Enter APAC market", tags: ["apac", "prospecting"], startDate: mkDate(14), endDate: mkDate(104), createdBy: "user_001" },
      { tenantId: "tenant_001", name: "Holiday Flash Sale", type: "performance", status: "paused", budget: { daily: 8000, lifetime: 80000, currency: "USD", spent: 32000, remaining: 48000 }, platforms: ["meta", "google", "tiktok"], goal: "Flash sale promotion", tags: ["holiday", "flash"], startDate: mkDate(-90), endDate: mkDate(-60), createdBy: "user_001" },
      { tenantId: "tenant_001", name: "LinkedIn Thought Leadership", type: "brand", status: "active", budget: { daily: 2500, lifetime: 75000, currency: "USD", spent: 18900, remaining: 56100 }, platforms: ["linkedin"], goal: "Establish executive thought leadership", tags: ["linkedin", "thought-leadership"], startDate: mkDate(-20), endDate: mkDate(40), createdBy: "user_001" },
      { tenantId: "tenant_001", name: "Webinar Registration Campaign", type: "performance", status: "active", budget: { daily: 1000, lifetime: 30000, currency: "USD", spent: 8400, remaining: 21600 }, platforms: ["meta", "google", "linkedin"], goal: "Drive webinar signups", tags: ["webinar", "lead-gen"], startDate: mkDate(-10), endDate: mkDate(10), createdBy: "user_001" },
    ];
