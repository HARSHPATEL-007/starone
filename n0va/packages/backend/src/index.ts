...
import campaignLandingPageAnalyzerRoutes from "./routes/campaign-landing-page-analyzer";
...
app.use("/api/v1/campaign-landing-page-analyzer", authMiddleware, tenantMiddleware, campaignLandingPageAnalyzerRoutes);
