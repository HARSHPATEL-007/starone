...
import campaignAIBiddingAgentRoutes from "./routes/campaign-ai-bidding-agent";
...
app.use("/api/v1/campaign-ai-bidding-agent", authMiddleware, tenantMiddleware, campaignAIBiddingAgentRoutes);
